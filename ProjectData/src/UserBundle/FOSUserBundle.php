...
use UserBundle\DependencyInjection\Compiler\CheckForMailerPass;
use UserBundle\DependencyInjection\Compiler\CheckForSessionPass;
use UserBundle\DependencyInjection\Compiler\InjectRememberMeServicesPass;
use UserBundle\DependencyInjection\Compiler\InjectUserCheckerPass;
use UserBundle\DependencyInjection\Compiler\ValidationPass;
...
class FOSUserBundle extends Bundle
{
    ...
    {
        $mappings = array(
            realpath(__DIR__.'/Resources/config/doctrine-mapping') => 'UserBundle\Model',
        );
