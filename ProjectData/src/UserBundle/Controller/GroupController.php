...
use UserBundle\Event\FilterGroupResponseEvent;
use UserBundle\Event\FormEvent;
use UserBundle\Event\GetResponseGroupEvent;
use UserBundle\Event\GroupEvent;
use UserBundle\Form\Factory\FactoryInterface;
use UserBundle\FOSUserEvents;
use UserBundle\Model\GroupInterface;
use UserBundle\Model\GroupManagerInterface;
